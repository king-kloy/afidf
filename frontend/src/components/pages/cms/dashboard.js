        ...
        return(
            <div className='dashboard'>
                ...
                <div className="container fluid border">
                    ...
                    <div className="col-md-10 " style={{border: 3, borderColor: '#f00'}}>
                        <h1 className="mt-4"><span className="fas fa-cog " aria-hidden="true"></span> Dashboard</h1>
                    </div>
                    <div className="col-md-2 create ">
                        <MDBDropdown>
                            <MDBDropdownToggle caret color="danger" style={{borderRadius: 5}}>
                              create
                            </MDBDropdownToggle>
            ...
            <div className="card card-default ">
              ...
              <div className="card-body">
                ...
                <div className="col-md-4 justify-content-center">
                  <div className="breadcrumb dash-box" style={{paddingLeft: 100}}>
                    <h2><span className="fas fa-list-alt" aria-hidden="true"></span> 12</h2>
                    <br/><h4>Pages</h4>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="breadcrumb dash-box" style={{paddingLeft: 100}}>
                    <h2><span className="fas fa-pen" aria-hidden="true"></span> 33</h2>
                    <h4>Posts</h4>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="breadcrumb dash-box" >
                    <h2><span className="fas fa-chart-bar" aria-hidden="true"></span> 12,334</h2>
                    <h4>Visitors</h4>
                  </div>
                </div>
                </div>
